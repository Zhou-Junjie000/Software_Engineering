...
function(t) {
    ...
    s.prototype.tabDelete = function(t, i) {
        ...
        var indexDempArr = [];
        for(var index = 0; index <indexArr.length-1;index++){
        	if(indexArr[index] == i || n.find('>li[lay-id="' + indexArr[index] + '"]').length==0){
        		continue;
        	}else{
        		indexDempArr.push(indexArr[index]);
        	}
        }
        indexArr=indexDempArr;
        if(indexArr.length>0){
        	tabChange(indexArr[indexArr.length-1],true);
            return f.tabDelete(null, s,true),
            this
        }else{
        	tabChange('',true);
            return f.tabDelete(null, s,false),
            this
        }
    },
    s.prototype.tabChange = function(t, i,noPush) {
        if(!i){
        	var value=top.layui.$("li.home cite").attr('data-value');
        	top.layui.$("li.home cite").html("首页"+value+"");
			top.layui.$("li.home .news-bell,li.home .flashing").hide();
			top.layui.$("li.home .news-num").removeClass("active");
        	indexArr=[];
        }else if(!noPush){
        	indexArr.push(i);
        }
    ...
    f = {
        ...
        tabDelete: function(t, i,isChange) {
