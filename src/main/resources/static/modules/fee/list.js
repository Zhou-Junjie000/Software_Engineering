layui.use(['form','layer','laydate','myTable','laytpl','formSelects','upload'],function(){
    ...
    var tableColumns = [
			...
			{field: 'cardid', title: '会员卡id', align:"center",sort:true},
			{field: 'fee', title: '缴费金额', align:"center", sort:true},
			{field: 'feetime', title: '缴费时间', align:"center", sort:true},
			{field: 'username', title: '缴费用户', align:"center", sort:true}
		];
//    if(PAGE_CONSTANT.type=='coach'){
//    	tableColumns = [
//			{type: "checkbox", fixed:"left", width:50},
//			{field: 'id', title: '主键',hide:true},
//			{field: 'coachid', title: '私教姓名', align:"center",sort:true},
//			{field: 'num', title: '课程数', align:"center", sort:true},
//			{field: 'fee', title: '缴费金额', align:"center", sort:true},
//			{field: 'feetime', title: '缴费时间', align:"center", sort:true},
//			{field: 'userid', title: '缴费用户', align:"center", sort:true}
//		];
//    }else if(PAGE_CONSTANT.type=='course'){
//    	tableColumns = [
//    			{type: "checkbox", fixed:"left", width:50},
//    			{field: 'id', title: '主键',hide:true},
//    			{field: 'courseid', title: '课程名称', align:"center",sort:true},
//    			{field: 'num', title: '课程数', align:"center", sort:true},
//    			{field: 'fee', title: '缴费金额', align:"center", sort:true},
//    			{field: 'feetime', title: '缴费时间', align:"center", sort:true},
//    			{field: 'userid', title: '缴费用户', align:"center", sort:true}
//    		];
//    }else if(PAGE_CONSTANT.type=='card'){
//    	tableColumns = [
//    			{type: "checkbox", fixed:"left", width:50},
//    			{field: 'id', title: '主键',hide:true},
//    			{field: 'cardid', title: '会员姓名', align:"center",sort:true},
//    			{field: 'fee', title: '缴费金额', align:"center", sort:true},
//    			{field: 'feetime', title: '缴费时间', align:"center", sort:true},
//    			{field: 'userid', title: '缴费用户', align:"center", sort:true}
//    		];
